...
const ENEMY_PATHS: Array[String] = [
	"res://data/enemies/mythic_001_vexmaw.tres",
	"res://data/enemies/mythic_002_thornling.tres",
	"res://data/enemies/mythic_003_duskfiend.tres",
	"res://data/enemies/mythic_004_grimhusk.tres",
	"res://data/enemies/mythic_005_netherclaw.tres",
	"res://data/enemies/mythic_006_bonewhirl.tres",
	"res://data/enemies/mythic_007_gloombeast.tres",
	"res://data/enemies/mythic_008_spineshard.tres",
	"res://data/enemies/mythic_009_ashwretch.tres",
	"res://data/enemies/mythic_010_mouldcreep.tres",
	"res://data/enemies/mythic_011_plaguelurk.tres",
	"res://data/enemies/mythic_012_cindertoad.tres",
	"res://data/enemies/mythic_013_hollowfang.tres",
	"res://data/enemies/mythic_014_murkspawn.tres",
	"res://data/enemies/mythic_015_razorwing.tres",
	"res://data/enemies/mythic_016_hexbrood.tres",
	"res://data/enemies/mythic_017_sludgecrawl.tres",
	"res://data/enemies/mythic_018_ironcaul.tres",
	"res://data/enemies/mythic_019_blightmaw.tres",
	"res://data/enemies/mythic_020_frosthaunt.tres",
	"res://data/enemies/mythic_021_voidcrawler.tres",
	"res://data/enemies/mythic_022_embervex.tres",
	"res://data/enemies/mythic_023_stonecurse.tres",
	"res://data/enemies/mythic_024_dreadscale.tres",
	"res://data/enemies/mythic_025_bloodthorn.tres",
	"res://data/enemies/mythic_026_shadowmeld.tres",
	"res://data/enemies/mythic_027_grimreaver.tres",
	"res://data/enemies/mythic_028_abyssalord.tres",
	"res://data/enemies/mythic_029_soulrender.tres",
	"res://data/enemies/mythic_030_doomhusk.tres",
	"res://data/enemies/mythic_031_netherlord.tres",
]
